        ...
        <div className=" mx-auto pt-16 -pb-10 max-w-7xl">
          <div className=" mx-auto flex flex-col ">
            ...
            <div className="mx-auto transition-all duration-1000 ease-in-out -mt-8">
              <Image
                ...
                height={800}
                width={800}
                className="select-none h-40 w-40 object-contain  rounded-full"
                alt="pravin nayak"
                priority
              />
            </div>
          ...
          <div className=" text-[0.92rem] text-base mx-12 font-light dark:text-white text-gray-900">
            ...
            <p className="">
              ...
              <a
                onClick={() =>
                  navigator.clipboard.writeText("pra12vin54@gmail.com")
                }
                ...
                href="mailto:pra12vin54@gmail.com"
              >
                {" "}
                pra12vin54@gmail.com
              </a>{" "}
              or <span className="text-blue-700 font-bold">LinkedIn</span>{" "}
              <a
                href="https://www.linkedin.com/in/pravinnayak/"
