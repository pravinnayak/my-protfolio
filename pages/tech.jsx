...
const tech = () => {
  let data = [
    ...
    },
    {
      ...
      desc: "Is an open-source, cross-platform JavaScript runtime environment that allows you to execute JavaScript code outside of a web browser.",
      tag: "Ennvironment",
      bg: "bg-blue-50",
      text: "text-blue-500",
    },
    ...
    },
    {
      title: "Python",
      id: 6,
      main: "/icons/python.ico",
      desc: "Python is a popular programming language. It was created by Guido van Rossum, and released in 1991.",
      tag: "Programming",
      bg: "bg-indigo-50",
    ...
    },
    {
      title: "Angular",
      id: 7,
      main: "/icons/angular.ico",
      desc: "Angular is a development platform, built on TypeScript.",
      tag: "Framework",
      bg: "bg-pink-300",
      text: "text-pink-800",
    },
    {
      title: "Docker",
      id: 8,
      main: "/icons/docker.svg",
      desc: "Docker is an open platform for developing, shipping, and running applications.",
      tag: "framework",
      bg: "bg-gray-900",
      text: "text-gray-100",
    },
    {
      title: "Graphql",
      id: 9,
      main: "/icons/graphql.svg",
      desc: "Is a query language for your API, and a server-side runtime for executing queries using a type system you define for your data.",
      tag: "Query",
      bg: "bg-orange-500",
    ...
    },
    {
      title: "Postgres",
      id: 11,
      main: "/icons/postgresql.png",
      desc: "PostgreSQL is an advanced relational database system.PostgreSQL supports both relational (SQL) and non-relational (JSON) queries.",
      tag: "Query",
      bg: "bg-orange-500",
      text: "text-orange-100",
    },
    {
      title: "Mongo",
      id: 11,
      main: "/icons/mongoDB.ico",
      desc: "MongoDB is a document database. It stores data in a type of JSON format called BSON.",
      tag: "Query",
      bg: "bg-orange-500",
      text: "text-orange-100",
    },
    ...
    },
    {
      title: "Algolia",
      id: 11,
      main: "/icons/algolia.svg",
      desc: "Algolia is a hosted search engine capable of delivering real-time results from the first keystroke.",
      tag: "Engine",
      bg: "bg-orange-500",
      text: "text-orange-100",
    },
    ...
    },
    {
      ...
      id: 11,
      main: "/icons/elasticsearch.svg",
      desc: "Elasticsearch is an open-source and distributed search and analytics engine built based on the Apache Lucene.",
      tag: "Engine",
      bg: "bg-orange-500",
      text: "text-orange-100",
    },
    {
      ...
      id: 11,
      main: "/icons/Software architecture.jpg",
      desc: "Defines fundamental organization of a system and more simply defines a structured solution.",
      tag: "Specialities",
      bg: "bg-orange-500",
      text: "text-orange-100",
    },
  ...
  useEffect(() => {
    ...
    console.log.apply(console, [
      "%c Technologies i have worked with. 🍾\n",
      ...
      <main className="max-w-screen max-w-5xl mx-auto">
        <div className="pt-24 flex flex-col mx-auto">
          ...
          <p className="mt-8 max-w-xl text-center md:w-[70%] mx-auto text-sm md:text-base lg:text-xl mb-2 px-2">
            Throughout my professional journey, I have gained extensive
            experience working with a wide range of technology stacks. Some of
            the most prominent ones are highlighted below
          </p>
